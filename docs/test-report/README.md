...
Исследование проводится автором вручную перед защитой. Готовый
комплект для проведения:

- [`manual/usability-protocol.md`](manual/usability-protocol.md) —
  протокол с 6 сценариями и целевыми временами.
- [`manual/sus-questionnaire.md`](manual/sus-questionnaire.md) —
  опросник SUS (10 вопросов).
- [`manual/sus-results.md`](manual/sus-results.md) — шаблон сводки
  для модератора (заполняется после сессий).

Целевой SUS ≥ 70 (приёмочный), ≥ 75 (целевой). Статус NFR-07 после
проведения сессий перенесётся в раздел «Выводы» шаблона сводки.
