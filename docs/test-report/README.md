...
|---|---|---|---|---|---|
| Функциональные (FR-01..FR-10) | 10 | 9 | 0 | 1 | [requirements-matrix.md](requirements-matrix.md) |
...
SUS-индекс — модерируемое исследование; NFR-09 — комплект документации;
FR-09 — экспорт PDF, заглушка во фронте).
